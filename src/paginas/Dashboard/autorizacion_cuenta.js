...
class Autorizacion extends Component {
   ...
   /*  state = {
    ...
    peticionPut = () => {
        const token = localStorage.getItem('token');
         axios.get("https://app-bucetas.herokuapp.com/api/conductor"+this.state.form.cedula_conductor,this.state.form, {
            headers: {
                'token': token
            }
        })
...
selecionarConductor=(lista)=>{
    ...
    render() {
        ...
        return (
            <div >
                  <button className="btn btn-success" onClick={()=>this.modalInsertar()} >Crear</button> 
                        ...
                        {this.state.lista.map(lista => {
                            return (
                                <tr>
                                    ...
                                    <td>
                                        <button className="btn btn-primary" onClick={()=>{this.selecionarConductor(lista); this.modalInsertar()}}> Editar</button>
                                    </td>
                                </tr>
                            )
                        })}
                ...
                <Modal isOpen={this.state.modalInsertar}>
                    ...
                    <ModalBody>
                        <div className="form-group">
                            ...
                            <input className="form-control" type="text" name="cedula_conductor" id="cedula_conductor"  readOnly onChange={this.handleChange} value={form.cedula} />
                            <br />
                            <label htmlFor="apellido_conductor">Apellido</label>
                            <input className="form-control" type="text" name="apellido_conductor" id="apellido_conductor" onChange={this.handleChange} value={form.apellido} />
                            <br />
                            <label htmlFor="nombre_conductor">Nombre</label>
                            <input className="form-control" type="text" name="nombre_conductor" id="nombre_conductor" onChange={this.handleChange}  value={form.nombre}/>
                            <br />
                            <label htmlFor="state_conductor">Estado</label>
                            <input className="form-control" type="text" name="state_conductor" id="state_conductor" onChange={this.handleChange} value={form.estado} />
                            <label htmlFor="numerorecorridomaximo">Numero Maximo de Recorridos</label>
                            <input className="form-control" type="text" name="numerorecorridomaximo" id="numerorecorridomaximo" onChange={this.handleChange} value={form.recorrido} />
                        </div>
                    </ModalBody>
